...
- Create two EC2 instances one's ami is `Amazon Linux 3` and the other is `Ubuntu 22.04`. Their tags will be `Name=aws-linux-3`, `Name=ubuntu-22.04` and `Name=tf-import-sg`.  Attach security group to these instances.
...
```bash
$ terraform import "aws_instance.tf-instances[1]" i-0c3578467a1b62024
...
```bash
$ terraform import aws_security_group.tf-sg sg-0188281189e5a19fa
